...
function Nav() {
  ...
  return (
    <div className="w-full fixed z-[100]">
      <div className="max-w-screen-2xl mx-auto h-[10vh] py-5 px-8 sm:p-15 text-white flex items-center justify-between">
        <motion.div
        ...
        >
          <svg
            ...
            className="w-[40%] sm:w-[35%] text-white"
            data-v-1932cced=""
          >
            <path
        ...
        {ChangeMenu ? (
          <motion.div
            ...
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ ease: Power4.easeInOut, duration: 0.9 }}
            className="small flex items-center justify-between gap-2 md:hidden"
          >
            <h1 className="text-lg font-semibold">Close</h1>
            <span className="text-3xl">
              <IoClose onClick={MenuOpen} />
            </span>
          </motion.div>
        ) : (
          <motion.div
        ...
        {ChangeMenu ? (
          ...
          >
            ...
            <h1 className="underline underline-offset-4 text-lg flex items-center gap-2">
              <MdCheckBoxOutlineBlank size={".8rem"} /> Now Hiring!
            </h1>
            <div className="px-5">
              <h1 className="text-md mb-2">Our Story</h1>
              <h1 className="text-md">Play Reel</h1>
            </div>
          </motion.div>
        ) : (
          <motion.div
            ...
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ ease: Power4.easeInOut, duration: 0.8 }}
            className="links hidden sm:flex items-center justify-between gap-5"
          >
            {["Work", "Studio", "News", "Contact"].map((items, i) => (
              <a key={i} className="text-sm">
                {items}
              </a>
            ))}
          </motion.div>
